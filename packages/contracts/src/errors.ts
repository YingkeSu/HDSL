...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  RATE_LIMITED: 'the upstream service rate limit was reached; retry after the reported time',
  NETWORK_UNAVAILABLE: 'the network is unavailable',
  SOURCE_ACCESS_DENIED:
    'the upstream service denied access (permissions, authentication or abuse protection)',
  SOURCE_NOT_FOUND: 'the upstream repository, ref, commit or package was not found',
